...
from dashboard.tables.table_of_visualizations_of_frequency_of_Zip_Code_vs_Zip_Code import \
...
details_with_table_of_visualizations_of_Number_Of_Mismatches_vs_Number = html.Details(
    children = [
        html.Summary("Table Of Visualizations Of Frequency Of Number Of Mismatches vs. Number"),
        table_of_visualizations_of_frequency_of_Number_Of_Mismatches_vs_Number
    ],
    style={"margin-left": "20px"}
)
...
details_with_table_of_visualizations_of_Year_Contract_Signed_vs_Year_Contract_Signed = html.Details(
    children = [
        html.Summary("Table Of Visualizations Of Frequency Of Year Contract Signed vs. Year Contract Signed"),
        table_of_visualizations_of_frequency_of_Year_Contract_Signed_vs_Year_Contract_Signed
    ],
    style={"margin-left": "20px"}
)

details_with_table_of_visualizations_of_Zip_Code_vs_Zip_Code = html.Details(
    children = [
        html.Summary("Table Of Visualizations Of Frequency Of Zip Code vs. Zip Code"),
        table_of_visualizations_of_frequency_of_Zip_Code_vs_Zip_Code
    ],
    style={"margin-left": "20px"}
)

details_with_table_of_visualizations_of_Modeled_Y1_RECs_vs_Modeled_Y1_RECs = html.Details(
    children = [
        html.Summary("Table Of Visualizations Of Frequency Of Modeled Y1 RECs vs. Modeled Y1 RECs"),
        table_of_visualizations_of_frequency_of_Modeled_Y1_RECs_vs_Modeled_Y1_RECs
    ],
    style={"margin-left": "20px"}
)
...
details_of_details_of_visualizations = html.Details(
    children = [
        ...
        details_with_table_of_visualizations_of_Number_Of_Mismatches_vs_Number,
