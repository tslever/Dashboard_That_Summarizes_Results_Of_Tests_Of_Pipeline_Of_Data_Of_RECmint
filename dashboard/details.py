...
from dashboard.tables.table_of_visualizations_of_Nameplate_and_nominal_power_of_table_Generators import \
    table_of_visualizations_of_Nameplate_and_nominal_power_of_table_Generators
from dashboard.tables.table_of_visualizations_of_AC_Capacity_of_table_Generators import \
    table_of_visualizations_of_AC_Capacity_of_table_Generators
...
from dashboard.tables.table_of_visualizations_of_AP_to_Date_of_table_Generators import \
    table_of_visualizations_of_AP_to_Date_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Average_Cost_Per_REC_of_table_Generators import \
    table_of_visualizations_of_Average_Cost_Per_REC_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Count_Of_Contracts_of_table_Generators import \
    table_of_visualizations_of_Count_Of_Contracts_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Count_Of_Generators_of_table_Generators import \
    table_of_visualizations_of_Count_Of_Generators_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Number_Of_Lifetime_RECs_of_table_Generators import \
    table_of_visualizations_of_Number_Of_Lifetime_RECs_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Annuity_Rate_of_table_Generators import \
    table_of_visualizations_of_Annuity_Rate_of_table_Generators
from dashboard.tables.table_of_visualizations_of_MS_of_table_Generators import \
    table_of_visualizations_of_MS_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Quantity_Of_Unpurchased_RECs_of_table_Generators import \
    table_of_visualizations_of_Quantity_Of_Unpurchased_RECs_of_table_Generators
from dashboard.tables.table_of_visualizations_of_frequency_of_STT1_Revenue_of_table_Generators import \
    table_of_visualizations_of_frequency_of_STT1_Revenue_of_table_Generators
from dashboard.tables.table_of_visualizations_of_frequency_of_Specific_Yield_of_table_Generators import \
    table_of_visualizations_of_frequency_of_Specific_Yield_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Number_Of_Mismatches_of_table_Generators import \
    table_of_visualizations_of_Number_Of_Mismatches_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Calculated_Y1_RECs_of_table_Generators import \
    table_of_visualizations_of_Calculated_Y1_RECs_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Year_Contract_Signed_of_table_Generators import \
    table_of_visualizations_of_Year_Contract_Signed_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Zip_Code_of_table_Generators import \
    table_of_visualizations_of_Zip_Code_of_table_Generators
from dashboard.tables.table_of_visualizations_of_Modeled_Y1_RECs_of_table_Generators import \
    table_of_visualizations_of_Modeled_Y1_RECs_of_table_Generators
from dashboard.tables.table_of_visualizations_of_VA_LIQP_of_table_Generators import \
    table_of_visualizations_of_VA_LIQP_of_table_Generators
...
details_with_table_of_visualizations_of_AC_Capacity_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_AC_Capacity_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_AP_to_Date_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_AP_to_Date_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Average_Cost_Per_REC_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Average_Cost_Per_REC_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Count_Of_Contracts_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Count_Of_Contracts_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Count_Of_Generators_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Count_Of_Generators_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Number_Of_Lifetime_RECs_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Number_Of_Lifetime_RECs_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Annuity_Rate_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Annuity_Rate_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_MS_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_MS_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Nameplate_and_nominal_power_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Nameplate_and_nominal_power_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Quantity_Of_Unpurchased_RECs_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Quantity_Of_Unpurchased_RECs_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_STT1_Revenue_of_tables_Generators = Details(
    ...
    table = table_of_visualizations_of_frequency_of_STT1_Revenue_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Specific_Yield_of_tables_Generators = Details(
    ...
    table = table_of_visualizations_of_frequency_of_Specific_Yield_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Number_Of_Mismatches_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Number_Of_Mismatches_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Calculated_Y1_RECs_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Calculated_Y1_RECs_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Year_Contract_Signed_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Year_Contract_Signed_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Zip_Code_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Zip_Code_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_Modeled_Y1_RECs_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_Modeled_Y1_RECs_of_table_Generators,
    indentation = 20
)
...
details_with_table_of_visualizations_of_VA_LIQP_of_table_Generators = Details(
    ...
    table = table_of_visualizations_of_VA_LIQP_of_table_Generators,
    indentation = 20
)
